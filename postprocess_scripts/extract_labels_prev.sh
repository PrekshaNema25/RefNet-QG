...
echo ${_PATH}
python /scratch/scratch4/preksha/questiongeneration/GCN_QG/postprocess_scripts/retreive.py $1/test_prev_final_results$5
...
then
	...
	python2 ${_PATH}/plt_attention.py $1/test_awf $1/predictions/test/test_prev_final_results_plabels_copy $2/test_field_modified $max_plots_save $1/plots/test
...
python2 ${_PATH}/bleu_script/pycocoevalcap/eval_bleu_perline.py $2/test_summary_prop_labels  $1/test_prev_final_results${5}_plabels_copy
#python2 ${_PATH}/bleu_script/pycocoevalcap/eval_bleu_perline.py $2/test_summary  $1/test_prev_final_results${5}_plabels
