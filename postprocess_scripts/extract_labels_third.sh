...
_PATH="/scratch/TheOneWhereThingsAreWorking/postprocess_scripts"
#_PATH="/scratch/scratch4/preksha/questiongeneration/GCN_QG/postprocess_scripts"
echo ${_PATH}
python ${_PATH}/retreive.py $1/test_third_final_results$5
...
if [ "$3" == "True" ]
then
	python2 ${_PATH}/postprocess.py $2/test_content $1/test_third_final_results${5}_plabels $1/test_third_attention_weights$5
...
python2 ${_PATH}/bleu_script/pycocoevalcap/eval_bleu_perline.py $2/test_summary  $1/test_third_final_results${5}_plabels_copy
